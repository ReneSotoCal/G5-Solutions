...
export default function AboutUs(){
   return( 
    ...
    <div className="font-normal text-md px-6 leading-relaxed indent-6 flex flex-col gap-2">
        <p>Mr. Terrill Gant, a United States Army Veteran and seasoned business leader, resides in Richmond Hill, Georgia, where he combines a passion for leadership and technology with a commitment to helping organizations succeed. As the founder and CEO of G5 Business Solutions, a CVE-Certified Service-Disabled Veteran-Owned Small Business, Mr. Gant has built a company that delivers innovative IT, logistics, and operational solutions to government and private-sector clients.
        Inspired by his years of military service, Mr. Gant established G5 Business Solutions to provide businesses with the tools and strategies they need to thrive in a rapidly evolving digital landscape.</p>
